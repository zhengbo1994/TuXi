(function (abp, angular) {
    ...
    abp.event.on('abp.dynamicScriptsInitialized', function () {
        console.log(abp.localization.abpWeb('DefaultError'));
        console.log(abp.localization.abpWeb('DefaultError401'));
        console.log(abp.localization.abpWeb('DefaultErrorDetail'));
        console.log(abp.localization.abpWeb('DefaultErrorDetail401'));
        console.log(abp.localization.abpWeb('DefaultErrorDetail403'));
