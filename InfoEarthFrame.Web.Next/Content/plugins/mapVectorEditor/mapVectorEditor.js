...
(function ($) {
    $.fn.mapVectorEditorCtl = function (settings) {
        ...
        var successTip = $('<div style="display:none;position:absolute;cursor:pointer;"><span class="map_editend" data-toggle="tooltip" data-placement="bottom" title="结束画图"><span class="map-editor-icon-uniE902"><span class="path1"></span><span class="path2"></span></span></span></div>');
        //开始画形状时的事件函数
        ...
        var editHtml = '<div class="edit-box" style="border:1px solid #ed625e;display:none;cursor:pointer;background:#fff;border-radius:3px;">' +
                           ...
                           '<span class="map_move" data-toggle="tooltip" data-placement="bottom" title="激活按钮可移动要素"><i class="fa fa-arrows"></i></span>' +
                       '</div>';
        ...
        //    console.log('resolution', mapView.getResolution());
        //    console.log('viewExtent', mapView.calculateExtent());
        //});
        //var dragPan = null;
        ...
        //    var currentExtent = mapView.calculateExtent();
        //    if (currentExtent[0] < defaluts.extent[0] || currentExtent[1] < defaluts.extent[1] || currentExtent[2] > defaluts.extent[2] || currentExtent[3] > defaluts.extent[3]) {
        //        if (dragPan) {
