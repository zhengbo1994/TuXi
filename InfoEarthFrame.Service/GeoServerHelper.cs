...
namespace InfoEarthFrame.Service
{
    public class GeoServerHelper
    {
        ...
        public void AddLayerGroup(string mapName, IEnumerable<string> targetLayers, IEnumerable<string> targetStyles)
        {
            ...
            _GeoServer.AddLayerGroup(mapName, targetLayers, targetStyles, _GeoWorkSpace);
        }
